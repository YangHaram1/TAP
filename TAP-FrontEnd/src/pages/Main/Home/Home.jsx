...
import { faS, faStar, faTicket } from '@fortawesome/free-solid-svg-icons'
            ...
            <div className={styles.view}>
                ...
                <div className={styles.tOpen}>
                    ...
                    <div className={styles.oConts}>
                        {openTicket.map((item, index) => {
                            return (
                                <div className={styles.oCont} key={index}>
                    ...
                    <div className={styles.moreOpenTicket}>
                        티켓 오픈 더보기
                    </div>
                </div>
