        ...
        <div className={styles.container}>
            ...
            <div className={styles.contents}>
                ...
                <div className={styles.bodyBtn}>
                    <button>쿠폰모두받기</button>
                </div>
            </div>
            <div className={styles.coupon}>
                <div className={styles.couponTitle}>
                    쿠폰 사용 안내 등급별 쿠폰은 바로 접속을 통한 경우만 적용 가능합니다.
                </div>
            ...
            <div className={styles.grade}>
                <div className={styles.gradeGrape}>
                    여기가 이제 등급표
                </div>
                <div className={styles.gContents}>
                    ...
                    <div className={styles.gDetail}>
                        인터파크 우수회원 등급은 매월 10일, 최근 6개월 구매확정 주문기준으로 선정됩니다. 주문 건수와 주문 금액 조건을 모두 충족하여야 합니다. 단, 결제에 사용된 할인쿠폰, 배송비, 티켓예매 수수료, 투어 렌터카 이용권, 제휴사를 통해 구매한 여행상품 등은 실적 대상에서 제 외됩니다.
                    </div>
                </div>
                <div className={styles.gContents}>
                    <div className={styles.gTitle}>
                    ...
                    <div className={styles.gDetail}>
                        <p><span>바로 접속</span>을 통한 주문 건만 우수회원 추가 포인트 적립 대상입니다.
                            <span>바로 접속이란?</span> 가격비교 사이트(네이버쇼핑, 다나와 등)를 통하지 않고 직접 인터파크에 방문하여 상품 구매/예약하신 주문을 말합니다.</p>

                    </div>
                    <div className={styles.gDetail}>
                        해당 주문의 결제 당시 회원 등급에 따라 우수회원 추가 포인트가 계산되며 주문 내 모든 상품 구매 확정시 자동으로 적립됩니다. 단, 일부 상품은 추가 포인트 적립대상에서 제외됩니다.
                    </div>
                    <div className={styles.gDetail}>
                        우수회원 추가 포인트는 최대 5,000P이고 유효기간은 12개월(365일)입니다.
                    </div>
                    <div className={styles.gDetail}>
                        약관에 위배되거나 비정상적인 거래 등의 부정거래 행위로 확인될 경우 당사자 동의 없이 적립취소(회수, 미적립 등) 될 수 있습니다.
                    </div>
                    <div className={styles.gDetail}>
            ...
            <div className={styles.footer}>
                ...
                <div className={styles.fBody}>
                    ...
                    <div className={styles.ceil}>
                        <span>공연, 스포츠 등 : 티켓 이용일+1일
                            공연예매권 구매, 전시 등 상시 상품 : 예매일+7일
                            Toping구매 : 결제일+8일
                        </span>
                    </div>
                    <div className={styles.ceil}>
                        <span>배송비, 예매수수료, 예매대기, 캠핑옵션추가 구매 제외.</span><br />
                        <span>예매권(공연/스포츠 등)포함 결제한 주문</span>
                    </div>
                    <div className={styles.ceil}>
                        <span>Toping 구매, 예매권(공연/스포츠 등)을 포함하여 결제한 경우 제외</span><br />
                ...
                <div className={styles.fBody}>
                    ...
                    <div className={styles.ceil}>
                        <span>해외항공 왕복 : 도착일+14일(편도:출발일+14일)</span><br />
                        <span>국내항공 : 출발일+14일</span><br />
                        <span>여행(해외/국내) : 도착일+14일</span><br />
                    ...
                    <div className={styles.ceil}>
                        <span>렌터카, 투어·티켓 구매, 제휴사를 통한 구매(홈쇼핑, 타 사이트)제외</span><br />
