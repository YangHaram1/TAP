package com.tap.chatupload.controller;
...
public class ChatUploadController {
	...
	@PostMapping
	public ResponseEntity<List<String>> upload(@RequestParam int group_seq, @RequestParam MultipartFile[] files,
			Principal principal) {
	...
	@PostMapping("/file")
	public ResponseEntity<List<ChatDTO>> uploadFile(@RequestParam int group_seq, @RequestParam MultipartFile[] files,
		...
		String username = principal.getName();
		List<ChatDTO> list=cserv.upload(files, group_seq, username);
